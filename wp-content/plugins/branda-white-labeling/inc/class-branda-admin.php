...
if ( ! class_exists( 'Branda_Admin' ) ) {
	...
	class Branda_Admin extends Branda_Base {
		...
		public function add_plugin_action_links( $actions, $plugin_file, $plugin_data, $context ) {
			...
			if ( ! empty( $admin_url ) ) {
				$settings_url      = add_query_arg( 'page', 'branding_group_data', $admin_url );
			...
			if ( Branda_Helper::is_pro() ) {
				...
				if ( is_network_admin() || ! is_multisite() ) {
					...
					$links['upgrade'] = '<a href="' . esc_url( $url ) . '" aria-label="' . esc_attr( __( 'Upgrade to Branda Pro', 'ub' ) ) . '" target="_blank" style="color: #8D00B1;">' . esc_html__( 'Upgrade', 'ub' ) . '</a>';
				}
			}
		...
		public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
			...
			if ( $branda_plugin_file === $plugin_file ) {
				if ( Branda_Helper::is_pro() ) {
					...
					$row_meta       = array(
						'rate'    => '<a href="https://wordpress.org/support/plugin/branda/reviews/#new-post" target="_blank">' . esc_html__( 'Rate Branda', 'ub' ) . '</a>',
						'support' => '<a href="https://wordpress.org/support/plugin/branda/" target="_blank">' . esc_html__( 'Support', 'ub' ) . '</a>',
					);
				}
		...
		public function add_admin_header_core() {
			...
			if ( defined( 'BRANDA_SUI_VERSION' ) ) {
				...
				wp_enqueue_style(
					'sui-styles',
					branda_url( 'assets/css/shared-ui.min.css' ),
					array(),
					$sui_body_class
				);
			}
			// Add in the core CSS file
			$file = branda_url( 'assets/css/ultimate-branding-admin.min.css' );
		...
		public function get_u_logo() {
			$image = '';
